...
test description
  ...
  s.homepage     = "http://hotel.idealo.de"
  ...
  s.source       = { :git => "https://github.com/Attila63/TestFramework.git", :tag => "0.0.3" }
  ...
  #
  s.ios.vendored_frameworks = "Output/TestFramework-Debug-iphoneuniversal/TestFramework.framework"
